  ...
  return (
    <div className="flex items-center gap-4">
      <button
        ...
        className="p-2 rounded-lg bg-zinc-200/30 dark:bg-white/5 backdrop-blur-md hover:scale-110 transition-all duration-300 silver-glow"
      >
        <Terminal
          aria-hidden="true"
          className={`w-5 h-5 transition-colors ${
            terminalMode ? "text-green-400" : "text-zinc-500 dark:text-zinc-400"
          }`}
        />
      </button>
